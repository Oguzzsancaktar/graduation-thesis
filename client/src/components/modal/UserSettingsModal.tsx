...
// Libs.
import { UserCreateOrUpdateModal, UserDatatable } from '..'
...
const UserSettingsModal = () => {
  ...
  const handleCreateUserClick = () => {
    openModal({
      ...
      content: <UserCreateOrUpdateModal />,
    })
  }
  return (
    ...
    <div className="relative h-full  overflow-x-auto shadow-md sm:rounded-lg">
      <div className="flex items-center justify-between p-4 bg-white dark:bg-gray-800">
        ...
        <button onClick={handleCreateUserClick} className="inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button" >
